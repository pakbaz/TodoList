...
output "container_app_name" { value = module.container_app.container_app_name }
output "container_app_url" { value = module.container_app.fqdn }
output "postgres_fqdn" { value = module.postgres.fqdn }
output "application_insights_connection_string" { value = module.monitoring.app_insights_connection_string }
